...
import com.teros.central_server.service.database.appm.app.AppHostService;
...
public class AppHostRestController {
    ...
    @GetMapping(value = "/appm/app/host/type/{id}")
    public ListResult<AppHostEntity> selectDataById(@PathVariable long id) {
        return responseService.getListResult(appHostService.getAppHostByTypeId(id));
    }
